...
public final class WPProtocol {
    ...
    public static final byte DATA_END_1 = (byte) 0xCC;
    public static final byte DATA_END_2 = (byte) 0xDD;
    ...
    public static final byte[] DATA_END = new byte[]{DATA_END_1, DATA_END_2};
