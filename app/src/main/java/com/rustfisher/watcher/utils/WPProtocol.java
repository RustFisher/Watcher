...
public final class WPProtocol {
    ...
    public static final int BASE_ONE_PACKAGE_DATA_LEN = 3000;

    public static final byte DATA_HEAD_1 = (byte) 0x33;
    public static final byte DATA_HEAD_2 = (byte) 0x44;
    public static final byte DATA_TYPE_STR = 0x01;
    ...
    public static final byte[] DATA_HEAD_STR = new byte[]{DATA_HEAD_1, DATA_HEAD_2, DATA_TYPE_STR};
    public static final byte[] DATA_HEAD_PNG = new byte[]{DATA_HEAD_1, DATA_HEAD_2, DATA_TYPE_PIC};
    public static final byte[] DATA_END = new byte[]{DATA_END_1, DATA_END_2, DATA_END_3};
    public static final int DATA_END_LEN = DATA_END.length;
